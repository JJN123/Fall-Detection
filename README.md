...
This is code developed while working at IATSL (http://iatsl.org/) as a PEY intern. It code can be used to detect falls in video, an example is given in the following GIFs
